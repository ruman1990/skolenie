...
class Sklad:
    ...
    def vypis_skladu_excel(self,file_path='sklad.xlsx'):
        ...
        columns = ["Produkt", "Cena", "Pocet kusov"]
        # 3. Zápis dát do hárku
        ws.append(columns)
        for riadok in self.produkty.values():
            ws.append([riadok.nazov,riadok.cena,riadok.pocet])
    ...
    def _export_skladu(self):
        ...
        for x in self.produkty:
            self.c.execute('insert into produkty (nazov,cena,pocet) VALUES (%s,%s,%s)',
